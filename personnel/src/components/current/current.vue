...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      getMessage () {
        ApiService.get('/api/v2/groupNews/newsList?categoryid=83&type=review&page=' + this.page).then(res => {
          this.show = false
      ...
      getImg () {
        ApiService.get('/api/v2/groupNews/imgList?categoryid=83&type=review').then(res => {
